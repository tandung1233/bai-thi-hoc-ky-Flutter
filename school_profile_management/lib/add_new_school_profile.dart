...
class AddNewSchoolProfile extends StatefulWidget {
  final BehaviorSubject? profile;
  const AddNewSchoolProfile({Key? key, this.profile}) : super(key: key);

  @override
  State<AddNewSchoolProfile> createState() => _AddNewSchoolProfileState();
}

class _AddNewSchoolProfileState extends State<AddNewSchoolProfile>
    with DialogsMixin {
                  ...
                  buttonTapped: () {
                    final item = SchoolProfileModel(
                      ...
                      firstYearProfile: SchoolProfilePerYear(
                        averageFirstSemester: double.parse(firstYear01.text),
                        averageSecondSemester: double.parse(firstYear02.text),
                      ),
                      secondYearProfile: SchoolProfilePerYear(
                        averageFirstSemester: double.parse(secondYear01.text),
                        averageSecondSemester: double.parse(secondYear02.text),
                      ),
                      thirdYearProfile: SchoolProfilePerYear(
                        averageFirstSemester: double.parse(thirdYear01.text),
                        averageSecondSemester: double.parse(thirdYear02.text),
                      ),
                    );
                    ...
                    showAlertDialog('Thông báo', 'Thêm học bạ thành công', 'ok',
                        () {
                      dissmissAlertDialog();
